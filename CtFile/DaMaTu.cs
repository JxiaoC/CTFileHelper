...
namespace DaMa {
    ...
    public class DaMaTuInit {
        /// <summary>
        /// 打码兔账号初始化
        /// </summary>
        /// <param name="Username"></param>
        /// <param name="Password"></param>
        public DaMaTuInit(string Username, string Password) {
            CtFile.PublicConfig.DaMaTu.Username = Username;
            CtFile.PublicConfig.DaMaTu.Password = Password;
        }
    }
    public static class Dama {
        private static String m_softKey = "378a2c6d76a01793508e71c60857dd87";
        private static String m_userName = CtFile.PublicConfig.DaMaTu.Username;
        private static String m_password = CtFile.PublicConfig.DaMaTu.Password;
        public static string Get(byte[] ba) {
            ...
            int ret = Dama2.D2Buf(
                ...
                m_password,     //password
                ba,         //图片数据，图片数据不可大于4M
                (uint)ba.Length, //图片数据长度
                60,         //超时时间，单位为秒，更换为实际需要的超时时间
                4,        //验证码类型ID，参见 http://wiki.dama2.com/index.php?n=ApiDoc.GetSoftIDandKEY
